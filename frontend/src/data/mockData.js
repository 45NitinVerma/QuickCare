...
export const mockUsers = [
  ...
  { id: '1',  role: 'Patient', name: 'Rohan Mehta',       email: 'rohan@patient.com',   age: 34, gender: 'Male',   dob: '1991-04-12', bloodGroup: 'O+',  mobile: '+91-9876543210', emergencyContact: { name: 'Priya Mehta', number: '+91-9898001234' }, address: '12, Shivaji Nagar, Pune', state: 'Maharashtra', city: 'Pune',   medicalInfo: { allergies: 'Penicillin', conditions: 'Hypertension', medications: 'Amlodipine 5mg' } },
  { id: '5',  role: 'Patient', name: 'Anjali Sharma',     email: 'anjali@patient.com',  age: 28, gender: 'Female', dob: '1997-08-22', bloodGroup: 'B+',  mobile: '+91-9845001122', emergencyContact: { name: 'Raj Sharma', number: '+91-9845551234' },  address: '45, Banjara Hills, Hyderabad', state: 'Telangana',   city: 'Hyderabad', medicalInfo: { allergies: 'None', conditions: 'None', medications: 'None' } },
  { id: '6',  role: 'Patient', name: 'Vikram Nair',       email: 'vikram@patient.com',  age: 45, gender: 'Male',   dob: '1980-01-30', bloodGroup: 'A+',  mobile: '+91-9711023344', emergencyContact: { name: 'Suma Nair', number: '+91-9711009988' },   address: '22, MG Road, Kochi', state: 'Kerala',       city: 'Kochi',     medicalInfo: { allergies: 'Sulfa drugs', conditions: 'Type 2 Diabetes', medications: 'Metformin 500mg' } },
  { id: '7',  role: 'Patient', name: 'Lakshmi Pillai',    email: 'lakshmi@patient.com', age: 62, gender: 'Female', dob: '1963-03-18', bloodGroup: 'AB+', mobile: '+91-9944332211', emergencyContact: { name: 'Suresh Pillai', number: '+91-9944001122' }, address: '3, Besant Nagar, Chennai', state: 'Tamil Nadu',   city: 'Chennai',   medicalInfo: { allergies: 'Aspirin', conditions: 'Arthritis, Hypothyroidism', medications: 'Levothyroxine 50mcg' } },
  { id: '8',  role: 'Patient', name: 'Arjun Kapoor',      email: 'arjun@patient.com',   age: 50, gender: 'Male',   dob: '1975-11-05', bloodGroup: 'B-',  mobile: '+91-9820001144', emergencyContact: { name: 'Meera Kapoor', number: '+91-9820551234' },  address: '7, Jubilee Hills, Hyderabad', state: 'Telangana',  city: 'Hyderabad', medicalInfo: { allergies: 'None', conditions: 'Asthma', medications: 'Salbutamol inhaler' } },
  { id: '9',  role: 'Patient', name: 'Divya Reddy',       email: 'divya@patient.com',   age: 22, gender: 'Female', dob: '2003-07-14', bloodGroup: 'O-',  mobile: '+91-9966112233', emergencyContact: { name: 'Ramesh Reddy', number: '+91-9966001234' },  address: '18, Film Nagar, Hyderabad', state: 'Telangana',    city: 'Hyderabad', medicalInfo: { allergies: 'Latex', conditions: 'None', medications: 'None' } },
  { id: '10', role: 'Patient', name: 'Suresh Iyer',       email: 'suresh@patient.com',  age: 39, gender: 'Male',   dob: '1986-09-27', bloodGroup: 'A-',  mobile: '+91-9445001234', emergencyContact: { name: 'Kavitha Iyer', number: '+91-9445551234' },  address: '9, T Nagar, Chennai', state: 'Tamil Nadu',         city: 'Chennai',   medicalInfo: { allergies: 'None', conditions: 'Migraine', medications: 'Sumatriptan 50mg' } },
  { id: '11', role: 'Patient', name: 'Pooja Singh',       email: 'pooja@patient.com',   age: 71, gender: 'Female', dob: '1954-12-03', bloodGroup: 'O+',  mobile: '+91-9811233445', emergencyContact: { name: 'Rahul Singh', number: '+91-9811001234' },   address: '15, Civil Lines, Delhi', state: 'Delhi',        city: 'New Delhi', medicalInfo: { allergies: 'None', conditions: 'Hypertension, Diabetes', medications: 'Lisinopril 10mg, Insulin' } },
  { id: '12', role: 'Patient', name: 'Kiran Desai',       email: 'kiran@patient.com',   age: 33, gender: 'Male',   dob: '1992-06-18', bloodGroup: 'B+',  mobile: '+91-9619001234', emergencyContact: { name: 'Neha Desai', number: '+91-9619551234' },   address: '56, Dadar, Mumbai', state: 'Maharashtra',           city: 'Mumbai',    medicalInfo: { allergies: 'None', conditions: 'None', medications: 'None' } },
  { id: '13', role: 'Patient', name: 'Sunita Gupta',      email: 'sunita@patient.com',  age: 47, gender: 'Female', dob: '1978-02-28', bloodGroup: 'AB-', mobile: '+91-9971112233', emergencyContact: { name: 'Ramesh Gupta', number: '+91-9971001234' },  address: '33, Karol Bagh, Delhi', state: 'Delhi',        city: 'New Delhi', medicalInfo: { allergies: 'Amoxicillin', conditions: 'Thyroid disorder', medications: 'Eltroxin 100mcg' } },
  // Staff
